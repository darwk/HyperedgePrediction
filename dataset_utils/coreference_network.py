...
def read_aminer_data_files(dataset_folder):
    ...
    file_list = get_file_paths("filePaths.txt", dataset_folder)
...
def read_citseer_data_files(dataset_folder):
...
def read_cora_data_files(dataset_folder):
    ...
    content_file_handle = open(dataset_folder + "/Cora/cora.content")
...
def get_coreference_network(dataset, dataset_folder):
    ...
    if dataset == "aminer":
        ...
        paperid_classid, classid_classname, reference_ids, coreferences_list = read_citseer_data_files(dataset_folder)
    elif dataset == "cora":
